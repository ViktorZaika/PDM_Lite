...
<div class="navbar navbar-static-top">
  	 <nav class="navbar-inner">
  	   <a href="home" class="brand"> <i  class="icon-home"></i>   Главная страница</a>
  	 	<ul class="nav">
 ...
 <c:if test="${!empty RulesList}">
	<table class="table table-hover"  style="height:110px;  overflow: auto;">
		<tr>
		<th>Код документа</th>
		<th>Имя документа</th>
		...
		<c:forEach items="${RulesList}" var="rules">
			<tr onclick="showContent('getRule/${rules.id}')">
				
				<td>${rules.code}</td>
				<td>${rules.doc_name}</td>
...
<input type="submit" onclick="showContent('getRule/0')"
				value="Создать новый" />
		     <input type="submit" onclick="showContent('searchrule')"
				value="Поиск"/>
<div id="resp">
    ...
    <div id="contentBody" style="width: 100%; float:left;">  
    </div>  
