...
<div id="mycont">
		<script src="resources/build/three.min.js"></script>

		<script src="resources/build/js/controls/TrackballControls.js"></script>

		<script src="resources/build/js/loaders/OBJLoader.js"></script>
		<script src="resources/build/js/Detector.js"></script>
		<script src="resources/build/js/libs/stats.min.js"></script>
		...
		function init() {
		  ...
		  container = document.getElementById('mycont');
		  ...
		  loader.load( 'resources/col.png', function ( image ) {
		    texture.image = image;
		  ...
		  loader.load( 'resources/kol1.obj', function ( event ) {
		    var object = event;
