...
<form:form method="post"  action="addrule" commandName="rules">
	...
	<table>
		...
		<tr>
			...
			<td><form:input path="doc_name"  value="${rules.doc_name}"/></td>
		</tr>
		<tr>
			<td><form:label path="code">
			Код
			</form:label></td>
			<td><form:input path="code"  value="${rules.code}"/></td>
		</tr>
...
<input type="file" name="file" size="50" value="${file.name}${file.extention}"/>
<br />
